...
import CounterContainer from '../containers/myRecord/interview/counterContainer'
import Test from '../containers/mainPage/title/test'
// smooth scroll 설정
...
function App() {
  return (
    <div>
      ...
      <Route exact path="/studyDetail" element={<StudyDetail/>} />
