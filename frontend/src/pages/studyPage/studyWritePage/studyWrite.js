            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              ...
              <Row>
                <Col sm className={styles.form}>
                  <div className={styles.formBorder}>
                    <TextEditor Content={body} setContent={setBody} imageHandler={imageHandler} />
                  </div>
                </Col>
              </Row>
              ...
              <div className={styles.imageBg}>
                <div className={styles.imageLocation}>
                  {Image && <img alt="썸네일없음" src={ImageFile} style={{ width: '100%' }} />}
                </div>
                <input type="file" onChange={imageHandler} name="chooesFile" />
              </div>
            </Form.Group>
          </Row>
          <div className={styles.buttonBg}>
            <button className={styles.button} type="submit" onClick={createData}>
              Post
            </button>
